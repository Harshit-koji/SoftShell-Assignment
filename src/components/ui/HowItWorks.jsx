...
export const HowItWorks = () => {
    ...
    return (
        <>
            <section className="container mt-4 mb-5  py-5 theme-text">
                ...
                <div className="row text-center">
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4">
                        <div className="p-4 border rounded shadow-sm h-100">
                            ...
                            <p className="theme-text">Submit details or proof of your software license to get started.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4">
                        <div className="p-4 border rounded shadow-sm h-100">
                            ...
                            <h5>Get Valuation</h5>
                            <p className="theme-text">We evaluate your license and show its market value.</p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-sm-6 col-md-4 mb-4">
                        <div className="p-4 border rounded shadow-sm h-100">
                            ...
                            <h5>Get Paid</h5>
                            <p className="theme-text">Receive payment securely after verification and approval.</p>
                        </div>
                    </div>
                </div>
            </section>
